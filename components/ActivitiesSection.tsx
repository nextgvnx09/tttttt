...
const ActivitiesSection: React.FC = () => {
  const activities = [
    { title: '-', icon: <Code />, cat: '-', desc: '-' },
    { title: '-', icon: <Palette />, cat: '-', desc: '-.' },
    { title: '-', icon: <Cpu />, cat: '-', desc: '-' },
    { title: '-', icon: <Camera />, cat: '-', desc: '-' },
    { title: '-', icon: <Music />, cat: '-', desc: '-' },
    { title: '-', icon: <Trophy />, cat: '-', desc: '-' },
  ];
