...
const DigitalHeritage: React.FC = () => {
 ...
 <br /> 
              <span className="text-[#D4AF37] italic font-serif-prestige font-light lowercase">Berkarakter</span>
            </h2>
            
            <p className="text-white/40 text-lg lg:text-3xl font-light leading-relaxed font-serif-prestige italic">
              "Berlandaskan semangat Mapalus, kami berkomitmen menciptakan lingkungan belajar yang inovatif bagi putra-putri Minahasa."
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
              <div className="p-8 rounded-[40px] bg-white/5 border border-white/10 group hover:border-[#D4AF37]/50 hover:bg-white/[0.02] transition-all cursor-default active:scale-95">
                ...
                <h4 className="text-white font-black text-xl mb-2">Kurikulum Terpadu</h4>
                <p className="text-white/30 text-sm leading-relaxed group-hover:text-white/60 transition-colors">Mengedepankan metode pembelajaran aktif untuk mempersiapkan siswa menghadapi tantangan di dunia pendidikan tinggi dan kerja.
</p>
              </div>
              <div className="p-8 rounded-[40px] bg-white/5 border border-white/10 group hover:border-[#D4AF37]/50 hover:bg-white/[0.02] transition-all cursor-default active:scale-95">
                <Sparkles className="h-8 w-8 text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" />
                <h4 className="text-white font-black text-xl mb-2">Karakter & Etika
</h4>
                <p className="text-white/30 text-sm leading-relaxed group-hover:text-white/60 transition-colors">Menanamkan nilai-nilai integritas dan semangat gotong royong sebagai identitas utama siswa SMAN 2 Tompaso.</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative rounded-[60px] lg:rounded-[100px] overflow-hidden aspect-square lg:aspect-[4/5] shadow-4xl border border-white/10 group">
              ...
              <div className="absolute bottom-10 left-10 right-10 p-8 lg:p-12 glass-nav-card !bg-white/5 !backdrop-blur-3xl rounded-[40px] border border-white/10 group-hover:border-[#D4AF37]/30 transition-all">
                <p className="text-white font-serif-prestige italic text-xl lg:text-3xl mb-8 leading-relaxed">
                  "Kami percaya bahwa setiap siswa memiliki potensi besar. Di sini, kami membimbing mereka untuk tumbuh menjadi pribadi yang mandiri dan berwawasan luas."
                </p>
