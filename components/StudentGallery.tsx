...
const StudentGallery: React.FC = () => {
  const works = [
    { title: '-', author: 'Preysi Pesik', img: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1964&auto=format&fit=crop', likes: '124' },
    { title: '-', author: 'Cakrawala L', img: 'https://images.unsplash.com/photo-1581093588401-fbb62a02f120?q=80&w=2070&auto=format&fit=crop', likes: '98' },
    { title: '-', author: 'Firen G.', img: 'https://images.unsplash.com/photo-1596402184320-417d7178b2cd?q=80&w=2070&auto=format&fit=crop', likes: '215' },
    { title: '-', author: 'Esterlita S', img: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop', likes: '86' },
  ];
