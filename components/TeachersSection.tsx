...
const TEACHERS_DATA: Teacher[] = [
  ...
  { name: 'Friskila R. M. Kolibu, S.Pd', role: 'Guru Biologi', type: 'guru' },
  ...
  { name: 'Silveria J. Umboh, S.Pd', role: 'Guru Sosiologi', type: 'guru' },
  ...
  { name: 'Oktaviani E. Laloan, S.AB', role: 'Staff TU', type: 'staf' },
];
